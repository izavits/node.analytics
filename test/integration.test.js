...
describe('Integration', function () {
    ...
    describe('#reset', function () {
        it('should remove a global', function () {
            ...
            global.two = {};
            integration.reset();
            assert(global.one === undefined);
            assert(global.two === undefined);
        });
        ...
        it('should reset window defaults', function () {
            ...
            var onerror = global.onerror;
            global.onerror = noop;
            global.onload = noop;
            integration.reset();
            assert(global.onerror === onerror);
            assert(global.onload === onload);
        });
    });
});
