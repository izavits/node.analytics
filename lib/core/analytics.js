 ...
 * @return {Analytics}
 */
Analytics.prototype.captureException = function (exception, fn) {
    var msg = {
        name: exception.name,
        message: exception.message,
        stack: exception.stack
    };
    this._invoke('captureException', new Track(msg));
    this.emit('captureException', exception);
    this._callback(fn);
    return this;
};
...
Analytics.prototype.setContext = function (traits, fn) {
    ...
    //this._invoke('setContext', traits);
